...
class Product extends Equatable {
  ...
  factory Product.fromSnapshots(DocumentSnapshot snap) {
    return Product(
      id: snap['id'] ?? '',
      name: snap['name'] ?? '',
  ...
  static List<Product> products = [
    Product(
      ...
      isPopular: false,
      description:
          'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed euismod, nunc ut aliquam aliquam, nunc nisl aliquam nisl, eget aliquam nisl nisl sit amet lorem. ',
    ),
    Product(
      id: 2,
      name: 'Soft Drink #2',
